...
export const translations = {
  en: {
    ...
    itemForm: {
      ...
      salePricePlaceholder: 'e.g. 2.99',
      quantity: 'Quantity',
      quantityPlaceholder: 'e.g. 2',
      expiryDate: 'Expiry date',
      category: 'Category',
      categoryPlaceholder: 'e.g. Dairy',
      optionalSectionTitle: 'Optional details',
      barcode: 'Barcode',
      ...
      searchingPhotos: 'Looking for product photos…',
  ...
  ko: {
    ...
    itemForm: {
      ...
      brand: '브랜드',
      salePrice: '판매 가격',
      salePricePlaceholder: '예: 2.99',
      quantity: '수량',
      quantityPlaceholder: '예: 2',
      expiryDate: '유통기한',
      category: '분류',
      categoryPlaceholder: '예: 유제품',
      optionalSectionTitle: '선택 정보',
      barcode: '바코드',
